  ...
  <div class="w-full">
    ...
    <div class="flex flex-col gap-7.5 max-md:gap-4">
      <div 
        ...
        :key="review.id" 
        class="py-8 px-6 flex items-start justify-between border-b border-slate-200 rounded-3xl max-md:flex-col max-md:items-stretch max-md:gap-4 max-md:py-6"
      >
        ...
        <div class="text-right text-sm text-slate-700/40 whitespace-nowrap max-md:whitespace-normal pt-1 max-md:text-left max-md:pl-16 max-md:pt-0">
