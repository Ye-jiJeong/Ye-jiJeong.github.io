...
<template>
  <div class="w-full">
    ...
    <ul class="grid gap-2.5 w-full max-lg:grid-cols-2 max-sm:grid-cols-1" :class="steps.length === 3 ? 'grid-cols-3' : 'grid-cols-4'">
  ...
  <div class="bg-slate-600/5 mt-8 rounded-2xl max-md:!mt-5 max-sm:!mt-2">
