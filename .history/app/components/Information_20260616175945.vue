        ...
        >
            <swiper-slide v-for="(item, idx) in infoList" :key="idx">
                ...
                <div class="relative w-full h-[202px] rounded-2xl overflow-hidden">
                    ...
                    <div class="absolute inset-0 z-10 pointer-events-none rounded-2xl border-3 border-transparent transition-colors duration-300  hover:-translate-y-2 hover:shadow-2xl"></div>
                </div>
