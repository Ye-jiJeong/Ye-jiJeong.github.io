...
<template>
  <div class="w-full mx-auto flex flex-col items-center px-11.25 max-sm:px-8 max-[440px]:px-0">
    ...
    <div class="w-full bg-muted-light border border-bs-gray rounded-2xl p-6 pb-8.5 flex flex-col gap-6 my-7.5 max-sm:my-5">
      <div v-for="section in formSections" :key="section.id" class="flex items-start max-[440px]:flex-col max-[440px]:gap-2">
