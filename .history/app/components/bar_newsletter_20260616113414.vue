...
<template>
  <div 
    ...
    class="mb-17 mt-14.5 bg-no-repeat py-12 px-14 rounded-2xl text-white bg-[position:center] bg-[size:cover] md:bg-[position:right_30px_center,_center] md:bg-[size:42%,_100%]"
  >
