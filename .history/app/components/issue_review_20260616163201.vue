  ...
  <div class="w-full">
    ...
    <div class="flex flex-col gap-7.5 max-md:gap-4">
      <div 
        ...
        :key="review.id" 
        class="py-8 px-6 flex items-start justify-between border-b border-slate-200 rounded-3xl max-md:flex-col max-md:items-stretch max-md:gap-4 max-md:py-6 max-md:overflow-hidden"
      >
        <div class="flex items-start gap-4">
          ...
          <div class="min-w-0 flex-1">
            ...
            <p class="text-lg mt-2 max-md:text-base max-md:mt-1 leading-relaxed">{{ review.content }}</p>
          </div>
        </div>
        
        <div class="text-right text-sm text-slate-700/40 whitespace-nowrap pt-1 max-md:text-left max-md:pl-16 max-md:pt-0 max-md:overflow-x-auto scrollbar-hide">
