...
<template>
  <div class="max-w-189.75 m-auto max-sm:max-w-full max-sm:w-full">
    <div class="bg-slate-100 p-4 rounded-full w-full max-sm:overflow-hidden">
      
      <ul class="relative isolate z-0 flex items-center gap-2.5 max-sm:overflow-x-auto max-sm:whitespace-nowrap max-sm:px-2 scrollbar-hide">
