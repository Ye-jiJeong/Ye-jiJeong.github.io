  ...
  <section class="flex items-end justify-between gap-6 max-md:!items-start">
    <div class="flex-1 ">
      ...
      <ul class="flex flex-col gap-1">
          <li v-for="(item, idx) in checkList" :key="idx" class="text-xl flex items-center gap-2.5 font-medium flex-wrap md:flex-nowrap lg:flex-wrap xl:flex-nowrap max-md:text-base">
