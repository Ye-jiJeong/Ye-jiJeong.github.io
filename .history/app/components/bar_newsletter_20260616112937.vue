...
<template>
  <div 
    :style="{ 
      ...
      backgroundPosition: 'right 35px center, center',
      backgroundSize: 'contain, 100%'
    }" 
    class="mb-17 mt-14.5 bg-no-repeat py-12 px-14 rounded-2xl text-white"
  >
    <TitleH3 text="모르면 손해 보는 사업자 필수 정보" class="text-white max-lg:w-85 max-lg:leading-tight" />
    <p class="mt-2 text-base opacity-90 max-lg:w-85 max-lg:leading-tight">사장님의 성공을 바라며, 꼭 필요한 실무 소식만 요약해 드립니다.</p>
