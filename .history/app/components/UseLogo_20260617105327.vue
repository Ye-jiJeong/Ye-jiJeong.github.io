...
<template>
  <div class="w-full">
    ...
    <div class="w-full mt-6.5">
      ...
      <Button text="더보기" class="hidden max-md:block w-full border border-primary bg-white text-primary rounded-xl py-4.5  mb-0 sm:py-3.5 text-center font-semibold text-base mt-5 transition-colors active:bg-primary/10" />
    </div>
  </div>
</template>
