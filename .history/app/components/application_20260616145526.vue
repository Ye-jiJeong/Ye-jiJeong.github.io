...
<template>
  <section class="flex items-end justify-between gap-6 max-md:!items-start max-sm:flex-col max-sm:gap-0">
    ...
    <div class="text-base flex gap-2.5 max-sm:w-full max-sm:mb-4">
    ...
    <div class="w-fit flex-shrink-0 max-lg:w-[46%] self-start max-sm:w-full max-sm:order-2 max-sm:mb-6">
    ...
    <div class="flex-1 min-w-0 max-sm:w-full max-sm:order-3">
