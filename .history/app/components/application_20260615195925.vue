  ...
  <section class="flex items-end justify-between max-md:flex-col max-md:items-start max-md:gap-8">
    <div>
      ...
      <ul class="flex flex-col gap-1">
          <li v-for="(item, idx) in checkList" :key="idx" class="text-xl max-lg:text-lg max-md:text-base flex items-center max-sm:flex-wrap gap-2.5 max-sm:gap-1.5 font-medium">
