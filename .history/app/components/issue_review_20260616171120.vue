...
<template>
  <div class="w-full">
    ...
    <div class="mt-13.5 flex items-center justify-between border-slate-100 mb-4 max-md:mt-8 max-sm:flex-col-reverse max-sm:gap-3">
      ...
      <div class="flex items-center text-base max-md:text-sm mb-7.5 max-sm:mb-0 max-sm:justify-end">
