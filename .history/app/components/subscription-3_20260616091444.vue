...
<template>
  <div class="w-full flex flex-col items-center">
      ...
      <div v-for="field in inputFields" :key="field.id" class="flex gap-2">
        ...
        <div v-if="field.wrapperClass">
          <span v-if="field.isText" :class="field.btnClass">
            <i v-if="field.iconName" class="text-lg" :class="field.iconName"></i>{{ field.btnText }}
          </span>
    ...
    <Button @click="$emit('nextStep')" text="구독 신청하기" class="bg-primary text-white py-4.5 px-14 mt-8" hideArrow />
  </div>
</template>
