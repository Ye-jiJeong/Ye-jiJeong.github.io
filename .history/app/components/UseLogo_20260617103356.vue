  ...
  <div class="w-full">
    ...
    <div class="hidden max-md:block w-full bg-[#ebf2f4]/60 p-6 rounded-3xl text-left">
      ...
      <div class="flex flex-col gap-3 w-full">
        <div v-for="cert in (isExpanded ? certList : certList.slice(0, 7))" :key="'mo-' + cert.id" class="w-full bg-white rounded-xl py-4 px-4 flex items-center justify-start max-sm:justify-center max-sm:text-center shadow-sm border border-slate-100/50">
