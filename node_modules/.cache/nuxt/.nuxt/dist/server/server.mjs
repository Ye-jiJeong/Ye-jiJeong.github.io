import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, provide, Fragment, defineComponent, toRefs, renderSlot, toHandlerKey, camelize, ref, watch, nextTick, h, Comment, mergeProps, cloneVNode, openBlock, createBlock, unref, withCtx, Teleport, createCommentVNode, watchEffect, markRaw, onScopeDispose, createTextVNode, toDisplayString, createElementBlock, renderList, createVNode, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, onServerPrefetch, toValue, resolveDynamicComponent, useSSRContext, useModel, mergeModels, resolveComponent, useSlots, useTemplateRef, useId, Suspense, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/enth0/yeji/kosignbiz/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/enth0/yeji/kosignbiz/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/enth0/yeji/kosignbiz/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/enth0/yeji/kosignbiz/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1 } from "vue-router";
import defu$1, { defu, defuFn } from "C:/Users/enth0/yeji/kosignbiz/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/enth0/yeji/kosignbiz/node_modules/ufo/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon } from "@iconify/vue";
import { klona } from "C:/Users/enth0/yeji/kosignbiz/node_modules/klona/dist/index.mjs";
import colors from "tailwindcss/colors";
import { useHead as useHead$1, headSymbol } from "C:/Users/enth0/yeji/kosignbiz/node_modules/@unhead/vue/dist/index.mjs";
...
import { hash } from "C:/Users/enth0/yeji/kosignbiz/node_modules/ohash/dist/index.mjs";
import { debounce } from "C:/Users/enth0/yeji/kosignbiz/node_modules/perfect-debounce/dist/index.mjs";
...
const _routes = [
  {
    name: "@ui",
    path: "/@ui",
    component: () => import("./_nuxt/_ui-CrSVpZvI.js")
  },
  {
    name: "sub01_01",
    path: "/sub01_01",
    component: () => import("./_nuxt/sub01_01-o6XNnHql.js")
  },
  {
    name: "sub01_02",
    path: "/sub01_02",
    component: () => import("./_nuxt/sub01_02-OH1NQFBR.js")
  },
  {
    name: "sub01_03",
    path: "/sub01_03",
    component: () => import("./_nuxt/sub01_03-D03mw3iA.js")
  },
  {
    name: "sub02",
    path: "/sub02",
    component: () => import("./_nuxt/sub02-DCf58_39.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BYRvwCKb.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DxUHI1iJ.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CKT_408q.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CzBGRVJx.js"));
...
export {
  ...
  useComponentProps as b,
  useAppConfig as c,
  _sfc_main$9 as d,
  entry_default as default,
  _sfc_main$a as e,
  _sfc_main$d as f,
  useForwardProps as g,
  _sfc_main$b as h,
  useFieldGroup as i,
