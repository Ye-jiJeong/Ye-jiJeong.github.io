import { defineComponent, computed, openBlock, createBlock, unref, mergeProps, withCtx, renderSlot, normalizeProps, guardReactiveProps, useSlots, createTextVNode, toDisplayString, createCommentVNode, useSSRContext, createVNode, Fragment, renderList, useId, ref } from "vue";
...
import { P as Primitive, b as useComponentProps, c as useAppConfig, t as tv, d as _sfc_main$8, p as pickLinkProps, e as _sfc_main$9, f as _sfc_main$a, g as useForwardProps, h as _sfc_main$b, i as useFieldGroup, j as useComponentIcons, k as useLocale, l as _sfc_main$c, u as useHead, m as _sfc_main$d } from "../server.mjs";
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$6), ...appConfig.ui?.card || {} })({
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    const appConfig = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig.ui?.pageLinks || {} })());
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: unref(props).as,
        "data-slot": "root",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<ul data-slot="list" class="${ssrRenderClass(ui.value.list({ class: unref(props).ui?.list }))}"${_scopeId}><!--[-->`);
            ssrRenderList(unref(props).links, (link, index) => {
              _push2(`<li data-slot="item" class="${ssrRenderClass(ui.value.item({ class: [unref(props).ui?.item, link.ui?.item] }))}"${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$8, mergeProps({ ref_for: true }, unref(pickLinkProps)(link), { custom: "" }), {
                        ...
                        if (_push4) {
                          ssrRenderSlot(_ctx.$slots, "link", {
                            ...
                            if (link.label || !!slots["link-label"]) {
                              _push4(`<span data-slot="linkLabel" class="${ssrRenderClass(ui.value.linkLabel({ class: [unref(props).ui?.linkLabel, link.ui?.linkLabel], active }))}"${_scopeId3}>`);
              ...
              createVNode("ul", {
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(unref(props).links, (link, index) => {
                  return openBlock(), createBlock("li", {
                    ...
                    createVNode(_sfc_main$8, mergeProps({ ref_for: true }, unref(pickLinkProps)(link), { custom: "" }), {
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig.ui?.separator || {} })({
      color: props.color,
            ...
            return [
              createVNode("div", {
                ...
                renderSlot(_ctx.$slots, "default", { ui: ui.value }, () => [
                  ...
                  }, toDisplayString(unref(props).label), 3)) : unref(props).icon ? (openBlock(), createBlock(_sfc_main$a, {
                    key: 1,
                    name: unref(props).icon,
                    "data-slot": "icon",
                    class: ui.value.icon({ class: unref(props).ui?.icon })
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                unref(props).avatar ? (openBlock(), createBlock(_sfc_main$b, mergeProps({
                  ...
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: unref(props).ui?.avatar })
                }), null, 16, ["size", "class"])) : unref(props).icon ? (openBlock(), createBlock(_sfc_main$a, {
                  key: 1,
                  name: unref(props).icon,
                  "data-slot": "icon",
                  class: ui.value.icon({ class: unref(props).ui?.icon })
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onClose() {
      if (hasPersistence.value) {
        ...
        (void 0).documentElement.style.setProperty(`--${id.value}-display`, "none");
      }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        as: unref(props).as,
        class: ["banner", ui.value.root({ class: [unref(props).ui?.root, unref(props).class] })],
        "data-banner-id": id.value,
        "data-slot": "root"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(props).to) {
              _push2(ssrRenderComponent(_sfc_main$8, mergeProps({
                "aria-label": unref(props).title
              }, { to: unref(props).to, target: unref(props).target, ..._ctx.$attrs }, {
                class: unref(prefix)("focus:outline-none"),
                tabindex: "-1",
                raw: ""
              }), {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div data-slot="left" class="${ssrRenderClass(ui.value.left({ class: unref(props).ui?.left }))}"${_scopeId2}></div><div data-slot="center" class="${ssrRenderClass(ui.value.center({ class: unref(props).ui?.center }))}"${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
                    if (unref(props).icon) {
                  ...
                  if (unref(props).title || !!slots.title) {
                    _push3(`<div data-slot="title" class="${ssrRenderClass(ui.value.title({ class: unref(props).ui?.title }))}"${_scopeId2}>`);
                    ssrRenderSlot(_ctx.$slots, "title", {}, () => {
                  ...
                  _push3(`</div><div data-slot="right" class="${ssrRenderClass(ui.value.right({ class: unref(props).ui?.right }))}"${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "close", { ui: ui.value }, () => {
                    if (unref(props).close) {
                      _push3(ssrRenderComponent(_sfc_main$c, mergeProps({
                        icon: unref(props).closeIcon || unref(appConfig).ui.icons.close,
                  ...
                  return [
                    ...
                    createVNode("div", {
                      ...
                      renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                        unref(props).icon ? (openBlock(), createBlock(_sfc_main$a, {
                          key: 0,
                          name: unref(props).icon,
                          "data-slot": "icon",
                          class: ui.value.icon({ class: unref(props).ui?.icon })
            ...
            return [
              unref(props).to ? (openBlock(), createBlock(_sfc_main$8, mergeProps({
                key: 0,
                "aria-label": unref(props).title
              }, { to: unref(props).to, target: unref(props).target, ..._ctx.$attrs }, {
                class: unref(prefix)("focus:outline-none"),
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/@nuxt/ui/dist/runtime/components/Banner.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const tailwindLinks = ref([
      { label: "Spacing", to: "https://tailwindcss.com/docs/padding", target: "_blank" },
      { label: "Sizing", to: "https://tailwindcss.com/docs/width", target: "_blank" },
      { label: "Typography", to: "https://tailwindcss.com/docs/font-family", target: "_blank" },
      { label: "Backgrounds", to: "https://tailwindcss.com/docs/background-attachment", target: "_blank" },
      { label: "Borders", to: "https://tailwindcss.com/docs/border-radius", target: "_blank" },
      { label: "Effects", to: "https://tailwindcss.com/docs/box-shadow", target: "_blank" },
      { label: "Tables", to: "https://tailwindcss.com/docs/border-collapse", target: "_blank" },
      { label: "Transitions & Animation", to: "https://tailwindcss.com/docs/transition-property", target: "_blank" },
      { label: "Transforms", to: "https://tailwindcss.com/docs/backface-visibility", target: "_blank" }
    ]);
    const nuxtUILinks = ref([
      { label: "Layout", to: "https://ui.nuxt.com/docs/components/app", target: "_blank" },
      { label: "Element", to: "https://ui.nuxt.com/docs/components/alert", target: "_blank" },
      { label: "Form", to: "https://ui.nuxt.com/docs/components/checkbox", target: "_blank" },
      { label: "Data", to: "https://ui.nuxt.com/docs/components/accordion", target: "_blank" },
      { label: "Navigation", to: "https://ui.nuxt.com/docs/components/breadcrumb", target: "_blank" },
      { label: "Overlay", to: "https://ui.nuxt.com/docs/components/context-menu", target: "_blank" },
      { label: "Page", to: "https://ui.nuxt.com/docs/components/auth-form", target: "_blank" },
      { label: "Dashboard", to: "https://ui.nuxt.com/docs/components/dashboard-group", target: "_blank" },
      { label: "Content", to: "https://ui.nuxt.com/docs/components/content-navigation", target: "_blank" }
    ]);
    const iconLinks = ref([
      { label: "XEIcon 2.4.0", to: "https://xpressengine.github.io/XEIcon/library-2.4.0.html", target: "_blank" },
      { label: "Iconify", to: "https://icon-sets.iconify.design/", target: "_blank" }
    ]);
    const semanticColors = ["primary", "secondary", "success", "info", "warning", "error", "neutral"];
    const colors = ["red", "orange", "amber", "lime", "green", "emerald", "teal", "cyan", "sky", "blue", "indigo", "violet", "purple", "fuchsia", "pink", "rose", "slate", "gray", "zinc", "neutral", "stone", "mauve", "olive", "mist", "taupe"];
    const colorValues = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UCard = _sfc_main$7;
      const _component_UPageLinks = _sfc_main$6;
      ...
      const _component_UBanner = _sfc_main$1;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_UCard, { class: "mb-10" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex p-4"${_scopeId}><aside class="w-64"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UPageLinks, {
              title: "Tailwind 가이드 바로가기",
              links: unref(tailwindLinks)
            }, null, _parent2, _scopeId));
            _push2(`</aside><aside class="w-64"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UPageLinks, {
              title: "Nuxt UI 가이드 바로가기",
              links: unref(nuxtUILinks)
            }, null, _parent2, _scopeId));
            _push2(`</aside><aside${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UPageLinks, {
              title: "Icon 바로가기",
              links: unref(iconLinks)
            }, null, _parent2, _scopeId));
            _push2(`</aside></div>`);
          } else {
            return [
              createVNode("div", { class: "flex p-4" }, [
                createVNode("aside", { class: "w-64" }, [
      ...
      _push(`<div><p class="text-xs">text-xs: 가나다라</p><p class="text-sm">text-sm: 가나다라</p><p class="text-base">text-base: 가나다라</p><p class="text-lg">text-lg: 가나다라</p><p class="text-xl">text-xl: 가나다라</p><p class="text-2xl">text-2xl: 가나다라</p><p class="text-3xl">text-3xl: 가나다라</p><p class="text-4xl">text-4xl: 가나다라</p><p class="text-5xl">text-5xl: 가나다라</p><p class="text-6xl">text-6xl: 가나다라</p><p class="text-7xl">text-7xl: 가나다라</p><p class="text-8xl">text-8xl: 가나다라</p><p class="text-9xl">text-9xl: 가나다라</p><p class="text-[30px]">text-[30px]: 가나다라</p><br><p class="font-thin">font-thin: 가나다라</p><p class="font-extralight">font-extralight: 가나다라</p><p class="font-light">font-light: 가나다라</p><p class="font-normal">font-normal: 가나다라</p><p class="font-medium">font-medium: 가나다라</p><p class="font-semibold">font-semibold: 가나다라</p><p class="font-bold">font-bold: 가나다라</p><p class="font-extrabold">font-extrabold: 가나다라</p><p class="font-black">font-black: 가나다라</p><p class="font-black">font-black: 가나다라</p><p class="font-[500]">font-[500]: 가나다라</p><br><div class="flex flex-wrap text-sm"><!--[-->`);
      ssrRenderList(colors, (color) => {
        _push(`<div class="w-34 mb-1"><!--[-->`);
        ssrRenderList(colorValues, (colorValue) => {
          _push(`<p class="${ssrRenderClass(`text-${color}-${colorValue} pl-1`)}">text-${ssrInterpolate(color)}-${ssrInterpolate(colorValue)}</p>`);
        });
        _push(`<!--]--></div>`);
      });
      _push(`<!--]--><div class="w-34 mb-1"><p class="text-black pl-1">text-black</p><p class="text-white pl-1 bg-black">text-white</p></div></div><br><div class="flex flex-wrap text-sm"><!--[-->`);
      ssrRenderList(colors, (color) => {
        _push(`<div class="w-34 mb-1"><!--[-->`);
        ssrRenderList(colorValues, (colorValue) => {
          _push(`<p class="${ssrRenderClass(`bg-${color}-${colorValue} pl-1`)}">bg-${ssrInterpolate(color)}-${ssrInterpolate(colorValue)}</p>`);
        });
        _push(`<!--]--></div>`);
      });
      _push(`<!--]--><div class="w-34 mb-1"><p class="bg-black pl-1 text-white">bg-black</p><p class="bg-white pl-1">bg-white</p></div></div>`);
      _push(ssrRenderComponent(_component_USeparator, { class: "my-3" }, null, _parent));
      _push(`<h2>Badge</h2><div class="flex gap-2"><!--[-->`);
      ssrRenderList(semanticColors, (semanticColor) => {
        _push(ssrRenderComponent(_component_UBadge, { color: semanticColor }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(semanticColor)}`);
            } else {
              return [
                createTextVNode(toDisplayString(semanticColor), 1)
              ];
            }
          }),
          _: 2
      ...
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_component_USeparator, { class: "my-3" }, null, _parent));
      _push(`<h2>Button</h2><div class="flex gap-2"><!--[-->`);
      ssrRenderList(semanticColors, (semanticColor) => {
        _push(ssrRenderComponent(_component_UButton, { color: semanticColor }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(semanticColor)}`);
            } else {
      ...
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_component_USeparator, { class: "my-3" }, null, _parent));
      _push(`<h2>Chip</h2><div class="flex gap-2"><!--[-->`);
      ssrRenderList(semanticColors, (semanticColor) => {
        _push(ssrRenderComponent(_component_UChip, { color: semanticColor }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UButton, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(semanticColor)}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(semanticColor), 1)
                    ];
      ...
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_component_USeparator, { class: "my-3" }, null, _parent));
      _push(`<h2>Banner</h2><div><!--[-->`);
      ssrRenderList(semanticColors, (semanticColor) => {
        _push(ssrRenderComponent(_component_UBanner, {
          color: semanticColor,
          title: semanticColor,
          class: "mb-1",
          close: ""
...
//# sourceMappingURL=_ui-CrSVpZvI.js.map
